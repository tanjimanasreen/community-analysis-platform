...
- 2026-09-10: Staged persistent SQLite translation cache (.cache/translation_cache.sqlite3) to S3 at cache/translation/translation_cache.sqlite3 (28,725,248 bytes, 12,595 records). Updated src/cloud/batch_runner.py to download translation cache prior to analytical pipeline execution and persist updated cache to S3 before publishing manifest.json. Excluded translation/ from stage cache downloads to prevent collisions. Added 5 unit tests in tests/unit/test_batch_runner.py.
