...
const routeQueryNames: Record<string, readonly string[]> = {
  ...
  [API_ROUTES.monthlyThemeTrends]: API_QUERY_KEYS.monthlyThemeTrends,
  [API_ROUTES.themeTimeline]: API_QUERY_KEYS.themeTimeline,
  [API_ROUTES.monthlyThemeClusters]: API_QUERY_KEYS.monthlyThemeClusters,
  [API_ROUTES.clusteredThemeTimeline]: API_QUERY_KEYS.clusteredThemeTimeline,
  [API_ROUTES.clusteredThemeEvidence]: API_QUERY_KEYS.clusteredThemeEvidence,
  [API_ROUTES.transitions]: API_QUERY_KEYS.transitions,
  [API_ROUTES.evolutionPaths]: [],
  [API_ROUTES.evolutionPathMobility]: [],
  [API_ROUTES.evolutionPathThemeSimilarity]: API_QUERY_KEYS.evolutionPathThemeSimilarity,
